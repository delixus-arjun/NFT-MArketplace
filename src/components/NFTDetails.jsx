...
function NFTDetails(props) {
  ...
  return (
    <> 
      <div style={{ display: "flex", flex: 0.5, padding: "1rem", gap: "1rem"}}>
        <div style={{ display: "flex", flex: 0.5 }}>
          <Card  style={{...styles.NFTs}}>
            ...
            <div style={{ "margin-top": "20px" }}>
              <button type="button" class="ant-btn ant-btn-primary ant-btn-lg"  onClick={() => handleSellClick(nft)}   style={{"width": "100px", "border-radius": "12px"}} >
                <span>Sell</span>
              </button>
            </div>
          </Card>
